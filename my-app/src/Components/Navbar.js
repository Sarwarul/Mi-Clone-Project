...
import { logo2} from "../data/data.json"
...
const Navbar=()=>{
     return(
        <div className="nav">
          <div className="logo1">
            <Link to= "/">
               <img id="logoImage" src={logo2} required alt="Not"/>
         </Link> 
         </div>
           ...
           <Link to="/laptop" className="navlinks">Laptops</Link>

           <Link to="/#lifestyle" className="navlinks">Fitness and Lifestyle</Link>
           <Link to="/homes" className="navlinks">Home</Link>
